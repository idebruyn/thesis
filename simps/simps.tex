...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/trigger/pt_HLT_PFJet450_new.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/bkgd_estimation_dataMC.pdf}\hfill%
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/closure_test_QCD_GenJets_exclusive_correct.pdf}\hfill%
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/data_vs_prediction_RunE_reweighted_exclusivebinning.pdf}\hfill%
...
\hline
0.2 & 902 & $\pm$ & 5 (stat.) & $\pm$ & 38 (syst.) & 546.5  & $\pm$ & 0.6 & 969 & 456 & 4.4 \\
...
0.05 & 1.28 & $\pm$ & 0.03 (stat.) & \multicolumn{2}{l |}{$\!\!\!^{+\ 3.24}_{-\ 1.28\,}$ (syst.)} & 0.6  & $\pm$ & 0.1 & 0 & 395 & 3.9 \\
0.04 & 0.55 & $\pm$ & 0.02 (stat.) & \multicolumn{2}{l |}{$\!\!\!^{+\ 2.81}_{-\ 0.55\,}$ (syst.)} & 0.24  & $\pm$ & 0.09 & 0 & 387 & 3.8 \\
0.03 & 0.22 & $\pm$ & 0.01 (stat.)& \multicolumn{2}{l |}{$\!\!\!^{+\ 7.68}_{-\ 0.22\,}$ (syst.)} & 0.08  & $\pm$ & 0.07 & 0 & 377 & 3.7 \\
\hline
\end{tabular}
\label{tab:results}
\end{table}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/ExclusionLimitGH_xsecVsM_ChF0p05_1leg_HybridNew_gmN_neutrons.pdf}\hfill%
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/ExclusionLimitGH_xsecVsM_ChF0p05_1leg_HybridNew_gmN_neutrons_unblinded.pdf}\hfill%
