...
\begin{figure}[ht]
  \centering
 \includegraphics[width=.85\textwidth]{CMS_lumi_allyears}
...
\begin{figure}[ht]
  \centering
 \includegraphics[width=.65\textwidth]{pixel.jpg}
...
\begin{figure}[ht]
 \centering
 \includegraphics[width = .75\textwidth]{Transverse_section}
...
\begin{figure}[ht]
 \centering
 \includegraphics[width = .5\textwidth]{ecal_res}
...
The expected transverse energy resolution for jets reconstructed from calorimeter information is shown in Figure~\ref{fig:JER} for various pseudorapidity regions: barrel jets ($|\eta| < 1.4$), endcap jets ($1.4 < |\eta| < 3.0$), and very forward jets ($3.0 < |\eta| < 5.0$). Details about the reconstruction of jets from calorimeter and tracking information will be given in Section~\ref{sec:jet_reconstruction}.

\begin{figure}[p]
  \centering
 \includegraphics[width=\textwidth]{hcal}
...
\begin{figure}[p]
  \centering
 \includegraphics[width=.8\textwidth]{JER}
...
\begin{figure}[ht]
  \centering
 \includegraphics[width=\textwidth]{muon_system_new}
...
\begin{figure}[ht]
  \centering
 \includegraphics[width=\textwidth]{muon_res}
...
\begin{figure}[ht]
  \centering
 \includegraphics[width=.64\textwidth]{lumi}
...
\begin{figure}[h!]
  \centering
 \includegraphics[width=.73\textwidth]{activefraction}
...
\begin{figure}[ht]
  \centering
 \includegraphics[width=.5\textwidth]{APVsaturation_muoneff}
