...
\begin{figure}[ht]
 ...
 \caption{The signal-to-noise ratio for clusters on reconstructed tracks in the first layer of the \ac{TOB} for a run before (blue) and after (black) the change of pre-amplifier drain speed. Figure taken from~\cite{Erik}.}
 \label{fig:SOverN}
\end{figure}
